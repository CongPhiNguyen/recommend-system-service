...
onehotencoder_x1 = OneHotEncoder(categories='auto', sparse=False)
predict_model_for_city_X = onehotencoder_x1.fit_transform(predict_model_for_city_X)
...
onehotencoder_predict_score_X = OneHotEncoder(categories='auto', sparse=False)
predict_score_X = onehotencoder_predict_score_X.fit_transform(predict_score_X)
